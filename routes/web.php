...
/* Route Admin */
Route::group(['middleware' => [ 'redict_login'], 'prefix' => 'admin'], function () {
    /* Route Dashboard */
...
Route::group(['middleware' => [
    'role:' . Roles::SYSTEM_ADMINISTRATOR->name . '|' . Roles::USER->name . ',admin',
]], function () {
        /* Route User */
    ...
    // Quản lý sản phâm
    Route::group(['middleware' => [
    'role:' . Roles::SYSTEM_ADMINISTRATOR->name . '|' . Roles::PRODUCT_MANAGE->name . ',admin',
]], function () {
        /* Route Brand */
    ...
    // Quản lý kho
Route::group(['middleware' => [
    'role:' . Roles::SYSTEM_ADMINISTRATOR->name . '|' . Roles::WAREHOUSE_STAFF->name . ',admin',
]], function () {
        /* Route Supplier */
    ...
    // Quản lý marketing
Route::group(['middleware' => [
    'role:' . Roles::SYSTEM_ADMINISTRATOR->name . '|' . Roles::MARKETING->name . ',admin',
]], function () {
        /* Route Banner */
    ...
    // quản lý đơn hàng
Route::group(['middleware' => [
    'role:' . Roles::SYSTEM_ADMINISTRATOR->name . '|' . Roles::ORDER_MANAGE->name . ',admin',
]], function () {
        /* Route Order */
    ...
    Route::group(['middleware' => ['role:' . Roles::SYSTEM_ADMINISTRATOR->name . ',admin',]], function () {
...
Route::group(['middleware' => [
    'role:' . Roles::SYSTEM_ADMINISTRATOR->name . '|' . Roles::EMPLOYEE->name . ',admin',
]], function () {
        /* Route employee */
