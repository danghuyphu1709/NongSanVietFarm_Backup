                ...
                <div class="col-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row border-top border-top-dashed d-flex justify-content-between mt-3 pt-3">
                                <div class="col-8">
                                    ...
                                    <div class="d-flex justify-content-between">
                                    <p>Giảm giá:</p>
                                        <p class="badge bg-warning-subtle text-success text-uppercase text-wrap">
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    @foreach ($orderHistoriesWithTransfers as $key => $historyWithTransfers)
                                        <div class="accordion-item border-0">
                                            <div class="accordion-header pt-2" id="heading{{ $key + 1 }}">
                                                <a class="accordion-button shadow-none {{ !$historyWithTransfers['showTransferHistory'] ? 'no-arrow' : '' }}" data-bs-toggle="collapse" href="#collapse{{ $key + 1 }}" aria-expanded="{{ $historyWithTransfers['showTransferHistory'] ? 'true' : 'false' }}" aria-controls="collapse{{ $key + 1 }}" style="padding: 0 0.5rem !important; background: white;">
                                                        ...
                                                        @foreach($historyWithTransfers['transferHistories'] as $transfer_history)
                                                            @foreach (TransferStatus::cases() as $statusTransfer)
                                                                @if($transfer_history->status == $statusTransfer->value)
                                                                    <h6 class="">{{ $statusTransfer->label() }} - <span class="fw-normal">{{ $transfer_history->warehouse }}</span></h6>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-3">
                            <ul class="list-unstyled mb-0 vstack gap-3">
                                <li class="mb-2">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{ $order->user->avatar ? $order->user->avatar : asset('client/assets/img/avatar.jpg') }}" alt="" class="avatar-sm rounded">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <li><i class="ri-mail-line me-2 align-middle text-muted fs-16 mb-2"></i>{{  $order->email }}</li>
                                <li><i class="ri-phone-line me-2 align-middle text-muted fs-16 mb-2"></i>{{  $order->phone }}</li>
