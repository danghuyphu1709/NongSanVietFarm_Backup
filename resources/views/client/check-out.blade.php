                ...
                <div class="row g-5">
                    <div class="col-md-12 col-lg-6 col-xl-6">
                        ...
                        <div class="form-item">
                            ...
                            <input type="tel" class="form-control" name="phone"  value="{{ $user->phone ?? old('phone') ?? '' }}">
                            @error('phone')
                        ...
                        <div class="form-item">
                            ...
                            <input type="text" class="form-control" placeholder="House Number Street Name" name="specific_address" value="{{ $user->address ?? old('specific_address') ?? ''}}">
