                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <!-- Name Field -->
                                <div class="col-md-6">
                                    <label for="name" class="form-label">Tên nhân viên <span style="color:red">*</span></label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <label for="province_id" class="form-label">Tỉnh / Thành phố <span style="color:red">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <label for="district_id" class="form-label">Quận / Huyện <span style="color:red">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <label for="ward_id" class="form-label">Xã / Phường <span style="color:red">*</span></label>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Vai Trò <span style="color:red">*</span></h4>
