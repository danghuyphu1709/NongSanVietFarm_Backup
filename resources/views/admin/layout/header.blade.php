...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="{{ route('dashboard')}}" class="logo d-flex align-items-center">
            <img src="#" alt="">
            <span class="d-none d-lg-block">Nông sản Việt Farm</span>
        </a>
    ...
    <nav class="header-nav ms-auto">
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown" >
                @php $notifications = \Illuminate\Support\Facades\Auth::guard('admin')->user()->notifications @endphp
                <a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
                    <i class="bi bi-bell"></i>
                    <span class="badge bg-primary badge-number" id="total-notification-new">{{  Auth::guard('admin')->user()->notifications()->count() }}</span>
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications" style="max-height: 400px; overflow-y: auto; width: 50vh" >
                    <li class="dropdown-header">
                        Bạn có <span id="total-notification">{{  Auth::guard('admin')->user()->unreadNotifications()->count() }}</span> thông báo mới.
                    </li>
            ...
            <li class="nav-item dropdown pe-3">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="{{ \Auth::guard('admin')->user()->avatar }}" alt="{{ \Auth::guard('admin')->user()->name }}" class="rounded-circle ">
