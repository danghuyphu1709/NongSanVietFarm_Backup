...
return [
    ...
    [
        ...
        'roles' => [Roles::SYSTEM_ADMINISTRATOR->name,Roles::STATICTIS->name],
        'subtitles' => [
            [
    ...
    [
        ...
        'icon' => 'bi bi-person',
        'roles' => [Roles::SYSTEM_ADMINISTRATOR->name, Roles::USER->name],
        'subtitles' => [
            [
    ...
    [
        ...
        'subtitles' => [
            [
                ...
                'roles' => [Roles::SYSTEM_ADMINISTRATOR->name, Roles::EMPLOYEE->name]
            ],
                [
